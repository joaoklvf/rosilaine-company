...
import { DeleteResult } from '../../base/delete-result';
...
export class EndCustomerService {
  ...
  private readonly API_URL = `${environment.apiUrl}/customers`;// URL to web api
  private readonly COLLECTION = 'end-customers'

  getUrlRequest(customerId: string) {
    return `${this.API_URL}/${customerId}/${this.COLLECTION}`
  }
